...
user.org:user:RSA_AXI_LITE:2.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: RSA_AXI_LITE_0, and set properties
  set RSA_AXI_LITE_0 [ create_bd_cell -type ip -vlnv user.org:user:RSA_AXI_LITE:2.0 RSA_AXI_LITE_0 ]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M01_AXI [get_bd_intf_pins microblaze_0_axi_periph/M01_AXI] [get_bd_intf_pins RSA_AXI_LITE_0/s00_axi]
  ...
  [get_bd_pins RSA_AXI_LITE_0/s00_axi_aclk] \
  ...
  [get_bd_pins RSA_AXI_LITE_0/s00_axi_aresetn] \
  [get_bd_pins microblaze_0_axi_periph/M01_ARESETN]
  connect_bd_net -net sys_clock_1  [get_bd_ports sys_clock] \
  [get_bd_pins clk_wiz_0/clk_in1]

  # Create address segments
  assign_bd_address -offset 0x00020000 -range 0x00001000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs RSA_AXI_LITE_0/s00_axi/reg0] -force
