...
user.org:user:RSA_APB:2.0\
user.org:user:Booth_Mult:1.0\
user.org:user:MedianFilter:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: RSA_APB_0, and set properties
  set RSA_APB_0 [ create_bd_cell -type ip -vlnv user.org:user:RSA_APB:2.0 RSA_APB_0 ]

  # Create instance: Booth_Mult_0, and set properties
  set Booth_Mult_0 [ create_bd_cell -type ip -vlnv user.org:user:Booth_Mult:1.0 Booth_Mult_0 ]

  # Create instance: MedianFilter_0, and set properties
  set MedianFilter_0 [ create_bd_cell -type ip -vlnv user.org:user:MedianFilter:1.0 MedianFilter_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net axi_apb_bridge_0_APB_M [get_bd_intf_pins RSA_APB_0/S_APB] [get_bd_intf_pins axi_apb_bridge_0/APB_M]
  connect_bd_intf_net -intf_net axi_apb_bridge_0_APB_M2 [get_bd_intf_pins Booth_Mult_0/S_APB] [get_bd_intf_pins axi_apb_bridge_0/APB_M2]
  connect_bd_intf_net -intf_net axi_apb_bridge_0_APB_M3 [get_bd_intf_pins MedianFilter_0/S_APB] [get_bd_intf_pins axi_apb_bridge_0/APB_M3]
  ...
  [get_bd_pins RSA_APB_0/S_CLK] \
  [get_bd_pins Booth_Mult_0/S_PCLK] \
  [get_bd_pins MedianFilter_0/S_CLK]
  ...
  [get_bd_pins RSA_APB_0/S_RST] \
  [get_bd_pins Booth_Mult_0/S_PRESETN] \
  [get_bd_pins MedianFilter_0/S_RSTN]
  connect_bd_net -net sys_clock_1  [get_bd_ports sys_clock] \
  [get_bd_pins clk_wiz_1/clk_in1]

  # Create address segments
  assign_bd_address -offset 0x44A00000 -range 0x00001000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs Booth_Mult_0/S_APB/MAP_0] -force
  assign_bd_address -offset 0x44A10000 -range 0x00001000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs MedianFilter_0/S_APB/MAP_0] -force
  assign_bd_address -offset 0x44A20000 -range 0x00001000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs RSA_APB_0/S_APB/Reg] -force
